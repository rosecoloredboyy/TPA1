...
import Foto from "../assets/about2.jpg";
    ...
    <>
      <div className="w-full py-12 px-6">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
          <img className="w-[460px] mx-auto my-4" src={Foto} alt="" />
          <div className="flex flex-col text-justify my-4">
            <p className="text-amber-400 font-bold text-xl">ABOUT</p>
            <h1 className="font-bold text-2xl sm:3xl md:text-5xl pt-1 pb-4">
              <Typed strings={["Tentang saya"]} typeSpeed={130} />
            </h1>
            <p className="font-medium text-base text-slate-700 lg:text-lg">
              Mahasiswa tahun ke dua Teknik Informatika dari Institut Teknologi Indonesia. Memiliki ketertarikan mendalam pada dunia desain dan web. Memiliki kemampuan mengoperasikan Adobe Illustrator, Adobe Photoshop, Figma, dan Elementor.
              Ingin menjadi UI/UX Designer.
            </p>
            <a href="https://drive.google.com/file/d/1bzEfTUTnpAY07ai0m9xQN2t0zs6Zb0M-/view?usp=sharing">
              <button className="text-base font-semibold text-white bg-amber-400 my-4 py-2 px-6 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">Curriculum Vitae</button>
            </a>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="w-full px-4">
            <div className="max-w-xl mx-auto text-center">
              <h4 className="font-semibold text-lg text-amber-400">Profile</h4>
              <h2 className="font-bold text-slate-900 text-3xl mb-2 sm:text-4xl">Media Sosial</h2>
              <p className="font-medium text-md text-slate-600 md:text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, debitis! Laborum quo</p>
            </div>
          </div>
