      ...
      <div className="pt-4 pb-16">
        <div className="w-full px-4">
          <div className="max-w-xl mx-auto text-center mb-16">
            <h4 className="font-semibold text-lg text-amber-400 mb-2">Portfolio</h4>
            <h2 className="font-bold text-slate-900 text-3xl mb-4 sm:text-4xl lg:text-5xl">
              <Typed strings={["Project"]} typeSpeed={150} />
            </h2>
          </div>
        </div>

        <div className="div w-full px-4 flex flex-wrap justify-center xl:w-11/12 xl:mx-auto">
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden hover:scale-105 duration-300">
              <img src={Satu} alt="Personal Web" width="w-full" />
            </div>
            <h3 className="font-semibold text-slate-900 mt-5 mb-3">Personal Website</h3>
            <p className="font-medium text-base text-slate-400">Project Website yang berisi informasi tentang diri saya.</p>
          </div>
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden hover:scale-105 duration-300">
              <img src={Dua} alt="Achievement Web Development" width="w-full" />
            </div>
            <h3 className="font-semibold text-slate-900 mt-5 mb-3">Mental Meds</h3>
            <p className="font-medium text-base text-slate-400">Project Website Mental Meds, sebuah website yang menyediakan berbagai layanan psikologi.</p>
          </div>
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden hover:scale-105 duration-300">
              <img src={Tiga} alt="Movie App" width="w-full" />
            </div>
            <h3 className="font-semibold text-slate-900 mt-5 mb-3">Movie App</h3>
            <p className="font-medium text-base text-slate-400">Project website yang menyediakan informasi mengenai film-film populer yang dibantu dengan TMDB API.</p>
          </div>
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden hover:scale-105 duration-300">
              <img src={Empat} alt="BMI Calculator" width="w-full" />
            </div>
            <h3 className="font-semibold text-slate-900 mt-5 mb-3">BMI Calculator</h3>
            <p className="font-medium text-base text-slate-400">Project membuat calculator untuk menentukan BMI (Body Mass Index) seseorang . User akan diminta untuk memasukkan tingi dan berat badannya.</p>
          </div>
        </div>
      </div>
