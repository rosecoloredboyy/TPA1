...
const Home = () => {
  return (
    <>
      <div className="text-amber-400 pt-4">
        <div className="flex flex-wrap">
          <div className="w-full self-center px-12 max-w-[1240px] lg:w-1/2">
            <h1 className="text-sm font-semibold text-primary md:text-lg">
              Halo, saya
              <span className="block font-bold text-slate-900 text-4xl lg:text-5xl">Alwan Alkautsar. P</span>
            </h1>
            <div className="font-semibold text-xl lg:text-2xl text-amber-400">
              <Typed strings={["Mahasiswa", "Freelancer", "Designer"]} typeSpeed={140} backSpeed={140} loop />
            </div>
            <p className="font-medium text-slate-400 mb-4 leading-relaxed">
              Do i really look like a guy with a<span className="text-slate-900 font-bold"> plan?</span>
            </p>
          </div>
          <div className="relative w-full self-end px-4 lg:w-1/2">
            <div className="mt-14 lg:mt-9 lg:right-0">
              <img src={Porto} alt="Alwan" className="max-w-full mx-auto" />
            </div>
            <span className="absolute -bottom-2 -z-10 left-1/2 -translate-x-1/2 md:scale-110">
              <svg width="450" height="380" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="#fbbf24"
                  d="M46.2,-27.7C55.6,-10.4,56,11.1,46.8,28.1C37.6,45.2,18.8,57.7,-3.7,59.9C-26.3,62,-52.6,53.8,-61.5,36.9C-70.4,20.1,-61.9,-5.4,-48.8,-24.8C-35.6,-44.3,-17.8,-57.7,0.3,-57.8C18.4,-58,36.8,-44.9,46.2,-27.7Z"
